...
def get_Data1(tickers_selected, tipo=""):
    ...
    return df.loc[d_ini:d_end], d_ini, d_end
    ...
    if tipo_ativo:
        ...
        if options:
            ...
            if _OK:
                ...
                df, data_inicio, data_fim = get_Data1(options, param_tipo)
                df1 = df.copy()
                #print("DF1 ---- ", df1.head())
                ...
                if (len(df) < 30):
                    ...
                    with col2:
                        ...
                        st.write(df_disp.style.background_gradient(cmap='Greens').set_precision(2),height=200)
                ...
                ##### INÍCIO DO PORT. MAX INDICE DE SHARPE
                        ...
                        st.markdown(''' ### **Pesos Percentuais para o Portfólio de Máx. Índice de Sharpe** ''')
                        plot_funcs1.pie_Plot_Tickers(df_Max_Sharpe, 'max_sharpe')

                        st.markdown(''' ### **Quantidades de Ações/Cotas para o Portfólio de Máx. Índice de Sharpe** ''')
                ...
                ##### PORTFOLIO DE RISCO MÁXIMO TOLERADO PELO INVESTIDOR 
                        ...
                        st.markdown(''' ### **Pesos Percentuais para o Portfólio de Risco Máx. Tolerado** ''')
                        plot_funcs1.pie_Plot_Tickers(df_Max_Risk, 'max_risk')

                        st.markdown(''' ### **Quantidades de Ações/Cotas para o Portfólio de Risco Máx. Tolerado** ''')
